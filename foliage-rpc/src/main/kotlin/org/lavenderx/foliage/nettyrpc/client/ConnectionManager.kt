...
open class ConnectionManager private constructor() {

    private val logger = loggerFor<ConnectionManager>()

    @Volatile private var connectionManager: ConnectionManager? = null
    ...
    protected var connectTimeoutMillis: Long = 6000
